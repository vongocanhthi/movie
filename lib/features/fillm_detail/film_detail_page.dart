...
import 'package:movie/features/fillm_detail/film_detail_viewmodel.dart';
...
class _FilmDetailPageState extends State<FilmDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: ViewModelBuilder<FilmDetalViewModel>.reactive(
        viewModelBuilder: () => FilmDetalViewModel(),
